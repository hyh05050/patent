  ...
  const features = [
    {
      fImg: fimg1,
      title: "자금조달",
      des: "예비창업자, 창업 초기 기업은<br/>특허 출원 실적으로 제출 가능!",
    },
    {
      fImg: fimg2,
      title: "사업화",
      des: "잦은 사업 피봇팅에도 안정적으로<br/>임시출원 후 기술 개발 완성 가능!",
    },
    {
      fImg: fimg3,
      title: "마케팅",
      des: "임시출원만으로도 ‘특허출원중’<br/>용어를 적법하게 사용 가능!",
    },
  ];
              ...
              <div className="col-lg-4 col-md-6 col-12" key={fitem}>
                <div className="wpo-features-item">
                  ...
                  <div className="wpo-features-text">
                    <h2>{feature.title}</h2>
                    <p dangerouslySetInnerHTML={{ __html: feature.des }}></p>
                  </div>
