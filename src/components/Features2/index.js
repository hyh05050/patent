  ...
  const features = [
    {
      fImg: fimg1,
      title: "출원일 선점",
      des: "사업화를 위한 발표<br/>아이디어 공개를 앞두고 있을 때",
    },
    {
      fImg: fimg2,
      title: "비용 절감",
      des: "매번 정규출원에 소요되는<br/>시간과 비용이 부담될 때",
    },
    {
      fImg: fimg3,
      title: "실적 확보",
      des: "특허 등록 가능성 여부는 불투명하지만<br/>특허 출원 실적이 필요할 때",
    },
  ];
              ...
              <div className="col-lg-4 col-md-6 col-12" key={fitem}>
                <div className="wpo-features-item">
                  ...
                  <div className="wpo-features-text">
                    <h2 style={{ fontSize: "25px" }}>{feature.title}</h2>
                    <p
                      dangerouslySetInnerHTML={{ __html: feature.des }}
                      style={{ fontSize: "19px", wordBreak: "keep-all" }}
                    ></p>
                  </div>
                </div>
              </div>
